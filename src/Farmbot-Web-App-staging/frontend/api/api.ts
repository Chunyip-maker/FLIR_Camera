...
export class API {
  ...
  /** /api/tokens/ */
  get tokensPath() {
    return `${this.baseUrl}/api/tokens/`
  }
  /** /api/password_resets/ */
  get passwordResetPath() {
    return `${this.baseUrl}/api/password_resets/`
  }
  /** /api/device/ */
  get devicePath() {
    return `${this.baseUrl}/api/device/`
  }
  /** /api/device/seed */
  get accountSeedPath() {
    return `${this.devicePath}seed`
  }
  /** /api/device/reset */
  get accountResetPath() {
    return `${this.devicePath}reset`
  }
  /** /api/users/ */
  get usersPath() {
  ...
  /** /api/peripherals/ */
  get peripheralsPath() {
    return `${this.baseUrl}/api/peripherals/`
  }
  /** /api/farm_events/ */
  get farmEventsPath() {
    return `${this.baseUrl}/api/farm_events/`
  }
  /** /api/regimens/ */
  get regimensPath() {
    return `${this.baseUrl}/api/regimens/`
  }
  /** /api/sequences/ */
  get sequencesPath() {
    return `${this.baseUrl}/api/sequences/`
  }
  /** /api/sequence_versions/ */
  get sequenceVersionsPath() {
    return `${this.baseUrl}/api/sequence_versions/`
  }
  /** /api/tools/ */
  get toolsPath() {
  ...
  /** /api/points/ */
  get pointsPath() {
    return `${this.baseUrl}/api/points/`
  }
  /** /api/point_groups/ */
  get pointGroupsPath() {
    return `${this.baseUrl}/api/point_groups/`
  }
  /** /api/points/?filter=all */
  get allPointsPath() {
    return `${this.pointsPath}?filter=all`
  }
  /** /api/points/search */
  get pointSearchPath() {
    return `${this.pointsPath}search`
  }
  /** Rather than returning ALL logs, returns a filtered subset.
   * /api/logs/search */
  get filteredLogsPath() {
    return `${this.baseUrl}/api/logs/search`
  }
  /** /api/logs/ */
  get logsPath() {
  ...
  /** /api/webcam_feed */
  get webcamFeedPath() {
    return `${this.baseUrl}/api/webcam_feeds/`
  }

  /** /api/web_app_config */
  get webAppConfigPath() {
    return `${this.baseUrl}/api/web_app_config/`
  }
  /** /api/fbos_config */
  get fbosConfigPath() {
    return `${this.baseUrl}/api/fbos_config/`
  }
  /** /api/firmware_config */
  get firmwareConfigPath() {
    return `${this.baseUrl}/api/firmware_config/`
  }
  /** /api/sensor_readings */
  get sensorReadingPath() {
    return `${this.baseUrl}/api/sensor_readings`
  }
  /** /api/sensors/ */
  get sensorPath() {
    return `${this.baseUrl}/api/sensors/`
  }
  /** /api/farmware_envs/:id */
  get farmwareEnvPath() {
    return `${this.baseUrl}/api/farmware_envs/`
  }
  /** /api/pin_bindings/:id */
  get pinBindingPath() {
    return `${this.baseUrl}/api/pin_bindings/`
  }
  /** /api/saved_gardens/:id */
  get savedGardensPath() {
    return `${this.baseUrl}/api/saved_gardens/`
  }
  /** /api/saved_gardens/snapshot */
  get snapshotPath() {
    return this.savedGardensPath + '/snapshot'
  }
  /** /api/saved_gardens/:id/apply */
  applyGardenPath = (gardenId: number) =>
    `${this.savedGardensPath}/${gardenId}/apply`
  get exportDataPath() {
    return `${this.baseUrl}/api/export_data`
  }
  /** /api/plant_templates/:id */
  get plantTemplatePath() {
    return `${this.baseUrl}/api/plant_templates/`
  }
  /** /api/telemetry/ */
  get telemetryPath() {
    return `${this.baseUrl}/api/telemetries/`
  }
  ...
  /** /api/alerts/:id */
  get alertPath() {
    return `${this.baseUrl}/api/alerts/`
  }
  /** /api/global_bulletins/:id */
  get globalBulletinPath() {
    return `${this.baseUrl}/api/global_bulletins/`
  }
  /** /api/folders */
  get foldersPath() {
    return `${this.baseUrl}/api/folders/`
  }
  // get syncPath() { return `${this.baseUrl}/api/device/sync/`; }
  /** /api/releases?platform=:platform */
  get releasesPath() {
    return `${this.baseUrl}/api/releases?platform=`
  }
  /** /api/feedback */
  get feedbackPath() {
    return `${this.baseUrl}/api/feedback`
  }
  /** /api/ai_feedbacks */
  get aiFeedbacksPath() {
    return `${this.baseUrl}/api/ai_feedbacks`
  }
  /** /api/featured_sequences */
  get featuredSequencesPath() {
    return `${this.baseUrl}/api/featured_sequences`
  }
  /** /api/wizard_step_results/:id */
  get wizardStepResultsPath() {
    return `${this.baseUrl}/api/wizard_step_results/`
  }
  /** /api/curves/:id */
  get curvesPath() {
    return `${this.baseUrl}/api/curves/`
  }
  /** /api/ai */
  get aiPath() {
