...
export function Thermal() {
  ...
  async function storeImage(id: string, base64data: string): Promise<void> {
  ...
  const handleDownload = async (base64Image: string, fileName: string = 'thermal_image.jpeg') => {
  ...
  const handleDownloadRGBMatrix = async (base64Image: string, timestamp: string) => {
    try {
  ...
  const handleDownloadFrequencyMatrix = async (base64Image: string, timestamp: string) => {
    try {
